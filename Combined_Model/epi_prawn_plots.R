...
#plot snail infection dynamics over time with volenhovenii stocking events  
  ...
  snail.vol.long.sei = subset(snail.vol.long, Infection != "N")
  
snail.vol = ggplot(data = snail.vol.long.sei, aes(x = time)) +
              theme_bw() +
...
#plot snail size dynamics over time with rosenbergii stocking events  
  ...
  snail.ros.long.sei = subset(snail.ros.long, Infection != "N")
  
snail.ros = ggplot(data = snail.ros.long.sei, aes(x = time)) +
                    theme_bw() +
