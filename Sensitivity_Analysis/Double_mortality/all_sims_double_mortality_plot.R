...
load("Sensitivity_Analysis/Double_mortality/double_mortality_sims.RData")
...
eum_time = ggplot(eum_dat, aes(x = P_nought/1000)) +
  ...
  png("~/RemaisWork/Schisto/Stanford/Prawn_Aquaculture/Figs/V3_Figs/Mortality_tests/eumetric curve/eumetric_curve_mortx2.png", 
...
#Combine plots to produce figure 2 #############
  ...
  png("~/RemaisWork/Schisto/Stanford/Prawn_Aquaculture/Figs/V3_Figs/Mortality_tests/aquaculture_cycle/aquaculture_summary_mortx2.png", 
      width = 750, height = 500)
...
#Produce supplementary figure of aquaculture dynamics across different stocking densities ########
  png("~/RemaisWork/Schisto/Stanford/Prawn_Aquaculture/Figs/V3_Figs/Mortality_tests/stocking_density/aquaculture_sims_mortx2.png", 
...
#Plot multipanel epi figure #######
  ...
  png("~/RemaisWork/Schisto/Stanford/Prawn_Aquaculture/Figs/V3_Figs/Mortality_tests/epi_sims/epi_sims_prawn_mortx2.png", 
