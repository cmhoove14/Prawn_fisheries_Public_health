#Investigate influence of mortality rate=0.037 (observed for P. clarkii in Halstead et al 2018 paper) on prawn aquaculture model results and reproduce Figs 2-5
...
save.image(file = "Sensitivity_Analysis/Mortality_037/mortality_037_sims.RData")  
