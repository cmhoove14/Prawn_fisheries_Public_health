...
# Worm burden over time with only MDA intervention #####
...
# snail infection dynamics over time with MDA events  ########
...
# worm burden over time with volenhovenii stocking events ######
...
# snail infection dynamics over time with volenhovenii stocking events  #########
...
# worm burden over time with rosenbergii stocking events  ###########
...
# snail infection dynamics over time with rosenbergii stocking events  ########
...
# worm burden over time with volenhovenii stocking events and mda events ##############
...
# snail infection dynamics under repeated MDA and volenhovenii stocking ##########
...
# worm burden over time with rosenbergii stocking events and mda events #######
...
# snail infection dynamics under repeated MDA and rosenbergii stocking #####
...
# plot combined 3-panel figure with combined worm burden trajectories with multiplot ###############   
  fig5.3p.layout = matrix(c(1,2,3), ncol = 1, byrow = T)

  multiplot(w.plot, snail.mda, snail.ros, layout = fig5.3p.layout)
