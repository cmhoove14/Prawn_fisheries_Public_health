...
#Simulate annual MDA for n years ########
  ...
  sim.mda = as.data.frame(ode(nstart,t.all,snail_epi_allvh_imm,par.snails.imm,
...
sim.mda.nomig = as.data.frame(ode(nstart,t.all,snail_epi_allvh_imm,par.snails.nomig,
                          events = list(data = mdas))) %>% 
    mutate(P = 0, #Add prawn variable to integrate with prawn stocking sims
           L = 0, #Add prawn variable to integrate with prawn stocking sims
           W = cov*Wt + (1-cov)*Wu,
...
```{r sim_script, include = FALSE}
source("Combined_Model/epi_no_diag_prawn_sim.R")
```
