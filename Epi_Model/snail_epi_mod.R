...
snail_epi = function(t, n, parameters) { 
  with(as.list(parameters),{
    ...
    M = m*0.5*W*phi # Miracidial density per person as a function of mean worm burden (W), miracidial shedding rate (m), and mating probability
...
nstart.sn = c(S1 = 5*area, S2 = 0, S3 = 0, E1 = 0, E2 = 0, E3 = 0, I2 = 0, I3 = 0, W = 10)
t.sn = seq(0,365*200,10)
...
par.snails=c(
  ...
  beta = 2e-7,       # Human-to-snail infection probability in reference area (infected snails/miracidia/snail/day); adjusted from Sokolow et al. 2015 (original value: 4e-6)
  ...
  lambda = 0.04,      # Snail-to-human infection probability scaled to 1 m^2 (composite including cercarial shedding, mortality, infection, survival to patency); adjusted from Sokolow et al. 2015 (original value: 0.1)
  ...
  k = 0.08,          #clumping parameter of the negative binomial distribution used in the mating probability function
